...
export default function SavingsTable({token}: {token: string}) {
  const {data, isLoading, error} = useQuery<SavingsType[]>({
              ...
              <tbody>
                {data?.map((savings) => (
                  ...
                  >
                    ...
                    <td className='px-4 py-3'>{savings.previousSavings}</td>
                    <td className='px-4 py-3'>{savings.currentSavings}</td>
                    <td className='px-4 py-3'>
                      {new Intl.DateTimeFormat('en-GB', {
                        dateStyle: 'full',
                      }).format(new Date(savings.createdAt))}
                    </td>
