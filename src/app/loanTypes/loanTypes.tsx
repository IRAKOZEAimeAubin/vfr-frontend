...
import CreateLoanTypes from './createLoanType'
...
export default function LoanTypesTable({token}: {token: string}) {
  ...
  return (
    <>
                ...
                <tbody>
                  {data?.map((loanType) => (
                    ...
                    >
                      ...
                      <td className='px-4 py-3'>{loanType.typeName}</td>
                      <td className='px-4 py-3'>
                        {loanType.interestRate * 100}%
                      </td>
                      <td className='px-4 py-3 flex items-center justify-evenly text-xl'>
                        <AiFillDelete className='bg-red-500 p-[2px] text-red-200 rounded' />
                        <AiFillEdit className='bg-green-500 text-green-200 p-[2px] rounded' />
                      </td>
                    </tr>
                  ))}
                </tbody>
      ...
      {createToggle && (
        <CreateLoanTypes token={token} setToggle={setCreateToggle} />
      )}
    </>
  )
}
